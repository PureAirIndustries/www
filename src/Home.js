          ...
          <section id='main'>
              ...
              <section id=''>
                  ...
                  <div className='gallery'>
                    <div className='col-md-12'>
                      ...
                      <br /><br /><br />
                      <div className='video col-md-6 col-xs-12 offers' style={{'border-right': '#95a5a6 solid 1em', 'border-radius': '10px'}}>
                        <div className='image img-responsive offer_item'>
                          ...
                          <img src='images/ext.png' alt='' className='img-responsive' />

                        </div>
                      </div>

                      <div className='video col-md-6 col-xs-12' style={{'padding-left': '6%', 'border-left': '#bdc3c7 solid 1em', 'border-radius': '10px'}}>
                        ...
                        <div className='image image-responsive offer_item'>
                          ...
                          <img src='images/money.png' alt='' className='img-responsive' />
                ...
                <div className='flex flex-2'>
                  <div className='video col video-card video-shadow' style={{'background': '#fff'}}>
                    <div className='image fit img-responsive'>
                      <img src='images/pic07.jpg' alt='' className='img-responsive' />
                      <div className='arrow'>
                  ...
                  <div className='video col video-card video-shadow' style={{'background': '#fff'}}>
                    <a target='_blank' rel='noopener noreferrer' href='https://air-pollution-eradication.mn.co/share/UTCEzigxfkBk1mMk' className='link'>
                      <div className='image fit'>
                        <img src='images/community.png' alt='' className='img-responsive' />
                        <div className='arrow'>
            ...
            <section id='contact'>
              <div className='social column'>
                <h3>About Us</h3>
                <img src='images/pure-air-logo.png' alt='' className='img-responsive' style={{'width': '60%', 'padding-bottom': '3%'}} />
            ...
            <section id='banner' style={{'background-image': 'url("images/city-after.png")'}}>
              <div className='inner'>
                <header>
