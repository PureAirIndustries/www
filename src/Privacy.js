          ...
          <section>
            <div className='inner col-xs-6 col-md-6 col-md-offset-3 col-xs-offset-3 blog'>
              ...
              <ol>
                ...
                <li className='sub-list'>For the purposes outlined in Clause 2, we may collect and process the following information about you:</li>
                <ol type='a'>
                ...
                <li className='sub-list'>We only retain personal data for so long as it is necessary. Data may be archived as long as the purpose for which the data was used still exists.</li>
                <li className='parent-list'>Uses made of the information</li>
                <li className='parent-list'>Disclosure of your information</li>
                <li className='sub-list'>We will keep your personal data we hold confidential but you agree we may provide information to:</li>
                  <ol type='a'>
                ...
                <li className='sub-list'>Any request under Clause 6.1 may be subject to a small administrative fee to meet our cost in processing your request.</li>
                <li className='parent-list'>Changes to our privacy policy</li>
                <li className='sub-list'>We may amend this policy from time to time by posting the updated policy on our Site. By continuing to use our Site after the changes come into effect means that you agree to be bound by the revised policy.</li>
                <li className='parent-list'>Contact us</li>
                <li className='sub-list'>If you have any questions, comments or requests regarding personal data, please address them to:</li>
